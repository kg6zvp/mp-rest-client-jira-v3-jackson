...
import com.atlassian.jira.v3.api.FiltersApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteFilter(id);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | The ID of the filter.
        try {
            void result = apiInstance.resetColumns(id);
            System.out.println(result);
        } catch (ApiException e) {
...
> Object setColumns(id, columnRequestBody)
...
public class Example {
    public static void main(String[] args) {
        ...
        FiltersApi apiInstance = new FiltersApi(defaultClient);
        Long id = 56L; // Long | The ID of the filter.
        ColumnRequestBody columnRequestBody = new ColumnRequestBody(); // ColumnRequestBody | The IDs of the fields to set as columns. In the form data, specify each field as `columns=id`, where `id` is the *id* of a field (as seen in the response for [Get fields](#api-rest-api-<ver>-field-get)). For example, `columns=summary`.
        try {
            Object result = apiInstance.setColumns(id, columnRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
