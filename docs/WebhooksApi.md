...
> void deleteWebhookById(containerForWebhookIDs)
...
import com.atlassian.jira.v3.api.WebhooksApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteWebhookById(containerForWebhookIDs);
