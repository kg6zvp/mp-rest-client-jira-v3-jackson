...
import com.atlassian.jira.v3.api.WorkflowSchemesApi;
...
> void deleteWorkflowMapping(id, workflowName, updateDraftIfNeeded)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteWorkflowMapping(id, workflowName, updateDraftIfNeeded);
            System.out.println(result);
        } catch (ApiException e) {
