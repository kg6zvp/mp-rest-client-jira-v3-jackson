...
import com.atlassian.jira.v3.api.DynamicModulesApi;
...
> void dynamicModulesResourceRegisterModulesPost(connectModules)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.dynamicModulesResourceRegisterModulesPost(connectModules);
            System.out.println(result);
        } catch (ApiException e) {
...
> void dynamicModulesResourceRemoveModulesDelete(moduleKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.dynamicModulesResourceRemoveModulesDelete(moduleKey);
            System.out.println(result);
        } catch (ApiException e) {
