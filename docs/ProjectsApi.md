...
import com.atlassian.jira.v3.api.ProjectsApi;
...
> void deleteProject(projectIdOrKey, enableUndo)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteProject(projectIdOrKey, enableUndo);
            System.out.println(result);
        } catch (ApiException e) {
...
> void deleteProjectAsynchronously(projectIdOrKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        String projectIdOrKey = "projectIdOrKey_example"; // String | The project ID or project key (case sensitive).
        try {
            void result = apiInstance.deleteProjectAsynchronously(projectIdOrKey);
            System.out.println(result);
        } catch (ApiException e) {
