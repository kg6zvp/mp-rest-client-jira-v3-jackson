...
import com.atlassian.jira.v3.api.ProjectRoleActorsApi;
...
> void deleteActor(projectIdOrKey, id, user, group, groupId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteActor(projectIdOrKey, id, user, group, groupId);
            System.out.println(result);
        } catch (ApiException e) {
