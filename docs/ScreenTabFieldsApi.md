...
import com.atlassian.jira.v3.api.ScreenTabFieldsApi;
...
> void removeScreenTabField(screenId, tabId, id)
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The ID of the field.
        try {
            void result = apiInstance.removeScreenTabField(screenId, tabId, id);
            System.out.println(result);
        } catch (ApiException e) {
