...
> void deleteCommentProperty(commentId, propertyKey)
...
import com.atlassian.jira.v3.api.IssueCommentPropertiesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteCommentProperty(commentId, propertyKey);
