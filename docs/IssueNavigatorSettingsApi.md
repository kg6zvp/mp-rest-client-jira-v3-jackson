...
import com.atlassian.jira.v3.api.IssueNavigatorSettingsApi;
...
> void setIssueNavigatorDefaultColumns(columnRequestBody)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.setIssueNavigatorDefaultColumns(columnRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
