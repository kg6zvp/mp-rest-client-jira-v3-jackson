...
import com.atlassian.jira.v3.api.PermissionSchemesApi;
...
> void deletePermissionScheme(schemeId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deletePermissionScheme(schemeId);
            System.out.println(result);
        } catch (ApiException e) {
...
> void deletePermissionSchemeEntity(schemeId, permissionId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deletePermissionSchemeEntity(schemeId, permissionId);
            System.out.println(result);
        } catch (ApiException e) {
