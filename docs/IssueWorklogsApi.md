...
import com.atlassian.jira.v3.api.IssueWorklogsApi;
...
> void deleteWorklog(issueIdOrKey, id, notifyUsers, adjustEstimate, newEstimate, increaseBy, overrideEditableFlag)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteWorklog(issueIdOrKey, id, notifyUsers, adjustEstimate, newEstimate, increaseBy, overrideEditableFlag);
            System.out.println(result);
        } catch (ApiException e) {
