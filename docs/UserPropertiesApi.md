...
> void deleteUserProperty(propertyKey, accountId, userKey, username)
...
import com.atlassian.jira.v3.api.UserPropertiesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteUserProperty(propertyKey, accountId, userKey, username);
