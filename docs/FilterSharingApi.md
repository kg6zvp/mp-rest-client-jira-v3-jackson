...
import com.atlassian.jira.v3.api.FilterSharingApi;
...
> void deleteSharePermission(id, permissionId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteSharePermission(id, permissionId);
            System.out.println(result);
        } catch (ApiException e) {
