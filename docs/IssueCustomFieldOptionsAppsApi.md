...
import com.atlassian.jira.v3.api.IssueCustomFieldOptionsAppsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        IssueFieldOptionCreateBean issueFieldOptionCreateBean = new IssueFieldOptionCreateBean(); // IssueFieldOptionCreateBean | 
        try {
            IssueFieldOption result = apiInstance.createIssueFieldOption(fieldKey, issueFieldOptionCreateBean);
...
> void replaceIssueFieldOption(fieldKey, optionId, replaceWith, jql, overrideScreenSecurity, overrideEditableFlag)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.replaceIssueFieldOption(fieldKey, optionId, replaceWith, jql, overrideScreenSecurity, overrideEditableFlag);
            System.out.println(result);
        } catch (ApiException e) {
