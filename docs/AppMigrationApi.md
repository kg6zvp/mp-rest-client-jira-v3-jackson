...
import com.atlassian.jira.v3.api.AppMigrationApi;
...
> void migrationResourceUpdateEntityPropertiesValuePut(atlassianTransferId, entityType, entityPropertyDetails)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.migrationResourceUpdateEntityPropertiesValuePut(atlassianTransferId, entityType, entityPropertyDetails);
            System.out.println(result);
        } catch (ApiException e) {
