...
import com.atlassian.jira.v3.api.UsersApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        UsersApi apiInstance = new UsersApi(defaultClient);
        NewUserDetails newUserDetails = new NewUserDetails(); // NewUserDetails | Details about the user to be created.
        try {
            User result = apiInstance.createUser(newUserDetails);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        String key = "key_example"; // String | This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide) for details.
...
> void removeUser(accountId, username, key)
...
public class Example {
    public static void main(String[] args) {
        ...
        String key = "key_example"; // String | This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
        try {
            void result = apiInstance.removeUser(accountId, username, key);
            System.out.println(result);
        } catch (ApiException e) {
...
> void resetUserColumns(accountId, username)
...
public class Example {
    public static void main(String[] args) {
        ...
        String username = "username_example"; // String | This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
        try {
            void result = apiInstance.resetUserColumns(accountId, username);
            System.out.println(result);
        } catch (ApiException e) {
...
> Object setUserColumns(userColumnRequestBody, accountId)
...
public class Example {
    public static void main(String[] args) {
        ...
        UsersApi apiInstance = new UsersApi(defaultClient);
        UserColumnRequestBody userColumnRequestBody = new UserColumnRequestBody(); // UserColumnRequestBody | The ID of a column to set. To set multiple columns, send multiple `columns` parameters.
        String accountId = "5b10ac8d82e05b22cc7d4ef5"; // String | The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.
        try {
            Object result = apiInstance.setUserColumns(userColumnRequestBody, accountId);
            System.out.println(result);
        } catch (ApiException e) {
