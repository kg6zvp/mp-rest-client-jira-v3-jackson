...
import com.atlassian.jira.v3.api.IssueRemoteLinksApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        RemoteIssueLinkRequest remoteIssueLinkRequest = new RemoteIssueLinkRequest(); // RemoteIssueLinkRequest | 
        try {
            RemoteIssueLinkIdentifies result = apiInstance.createOrUpdateRemoteIssueLink(issueIdOrKey, remoteIssueLinkRequest);
...
> void deleteRemoteIssueLinkByGlobalId(issueIdOrKey, globalId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteRemoteIssueLinkByGlobalId(issueIdOrKey, globalId);
            System.out.println(result);
        } catch (ApiException e) {
...
> void deleteRemoteIssueLinkById(issueIdOrKey, linkId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteRemoteIssueLinkById(issueIdOrKey, linkId);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        RemoteIssueLinkRequest remoteIssueLinkRequest = new RemoteIssueLinkRequest(); // RemoteIssueLinkRequest | 
        try {
            Object result = apiInstance.updateRemoteIssueLink(issueIdOrKey, linkId, remoteIssueLinkRequest);
            System.out.println(result);
        } catch (ApiException e) {
