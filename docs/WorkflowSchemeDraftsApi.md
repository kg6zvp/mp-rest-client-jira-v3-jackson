...
import com.atlassian.jira.v3.api.WorkflowSchemeDraftsApi;
...
> void deleteDraftWorkflowMapping(id, workflowName)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteDraftWorkflowMapping(id, workflowName);
            System.out.println(result);
        } catch (ApiException e) {
...
> void deleteWorkflowSchemeDraft(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteWorkflowSchemeDraft(id);
            System.out.println(result);
        } catch (ApiException e) {
...
> void publishDraftWorkflowScheme(id, publishDraftWorkflowScheme, validateOnly)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.publishDraftWorkflowScheme(id, publishDraftWorkflowScheme, validateOnly);
            System.out.println(result);
        } catch (ApiException e) {
