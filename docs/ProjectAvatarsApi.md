...
import com.atlassian.jira.v3.api.ProjectAvatarsApi;
...
> void deleteProjectAvatar(projectIdOrKey, id)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteProjectAvatar(projectIdOrKey, id);
            System.out.println(result);
        } catch (ApiException e) {
