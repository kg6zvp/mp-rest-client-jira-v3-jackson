...
import com.atlassian.jira.v3.api.IssueTypesApi;
...
> void deleteIssueType(id, alternativeIssueTypeId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deleteIssueType(id, alternativeIssueTypeId);
            System.out.println(result);
        } catch (ApiException e) {
