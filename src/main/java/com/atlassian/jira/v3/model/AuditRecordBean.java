...
public class AuditRecordBean {
	...
	/**
	 * The category of the audit record. For a list of these categories, see the help article [Auditing in Jira applications](<a href="https://confluence.atlassian.com/x/noXKM">...</a>).
	 **/
