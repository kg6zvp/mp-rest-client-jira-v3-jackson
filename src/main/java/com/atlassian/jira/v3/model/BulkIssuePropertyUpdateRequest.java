...
public class BulkIssuePropertyUpdateRequest {
	...
	/**
	 * The value of the property. The value must be a [valid](<a href="https://tools.ietf.org/html/rfc4627">...</a>), non-empty JSON blob. The maximum length is 32768 characters.
	 **/
