...
public interface IssuePropertiesApi {
	...
	void bulkDeleteIssueProperty(@PathParam("propertyKey") String propertyKey, IssueFilterForBulkPropertyDelete issueFilterForBulkPropertyDelete) throws ApiException, ProcessingException;
	 ...
	 */
	@POST
	@Path("/properties/multi")
	@Consumes({"application/json"})
	@Produces({"application/json"})
	void bulkSetIssuePropertiesByIssue(MultiIssueEntityProperties multiIssueEntityProperties) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	void bulkSetIssueProperty(@PathParam("propertyKey") String propertyKey, BulkIssuePropertyUpdateRequest bulkIssuePropertyUpdateRequest) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	void bulkSetIssuesPropertiesList(IssueEntityProperties issueEntityProperties) throws ApiException, ProcessingException;
	...
	void deleteIssueProperty(@PathParam("issueIdOrKey") String issueIdOrKey, @PathParam("propertyKey") String propertyKey) throws ApiException, ProcessingException;
	...
	@Path("/{issueIdOrKey}/properties/{propertyKey}")
	@Produces({"application/json"})
	EntityProperty getIssueProperty(@PathParam("issueIdOrKey") String issueIdOrKey, @PathParam("propertyKey") String propertyKey) throws ApiException, ProcessingException;
	...
	@Produces({"application/json"})
	PropertyKeys getIssuePropertyKeys(@PathParam("issueIdOrKey") String issueIdOrKey) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	Object setIssueProperty(@PathParam("issueIdOrKey") String issueIdOrKey, @PathParam("propertyKey") String propertyKey, Object body) throws ApiException, ProcessingException;
}
