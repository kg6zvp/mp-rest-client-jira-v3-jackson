...
@Path("/rest/api/3")
public interface IssueAttachmentsApi {
	...
	List<Attachment> addAttachment(@PathParam("issueIdOrKey") String issueIdOrKey) throws ApiException, ProcessingException;
	 ...
	 */
	@GET
	@Path("/attachment/{id}/expand/human")
	@Produces({"application/json"})
	AttachmentArchiveMetadataReadable expandAttachmentForHumans(@PathParam("id") String id) throws ApiException, ProcessingException;
	 ...
	 */
	@GET
	@Path("/attachment/{id}/expand/raw")
	@Produces({"application/json"})
	AttachmentArchiveImpl expandAttachmentForMachines(@PathParam("id") String id) throws ApiException, ProcessingException;
	...
	@Path("/attachment/{id}")
	@Produces({"application/json"})
	AttachmentMetadata getAttachment(@PathParam("id") String id) throws ApiException, ProcessingException;
	 ...
	 */
	@GET
	@Path("/attachment/content/{id}")
	@Produces({"application/json"})
	List<Object> getAttachmentContent(@PathParam("id") String id, @QueryParam("redirect") @DefaultValue("true") Boolean redirect) throws ApiException, ProcessingException;
	...
	@Produces({"application/json"})
	AttachmentSettings getAttachmentMeta() throws ApiException, ProcessingException;
	 ...
	 */
	@GET
	@Path("/attachment/thumbnail/{id}")
	@Produces({"application/json"})
	List<Object> getAttachmentThumbnail(@PathParam("id") String id, @QueryParam("redirect") @DefaultValue("true") Boolean redirect, @QueryParam("fallbackToDefault") @DefaultValue("true") Boolean fallbackToDefault, @QueryParam("width") Integer width, @QueryParam("height") Integer height) throws ApiException, ProcessingException;
	...
	@DELETE
	@Path("/attachment/{id}")
	void removeAttachment(@PathParam("id") String id) throws ApiException, ProcessingException;
}
