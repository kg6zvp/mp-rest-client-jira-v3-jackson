...
import com.atlassian.jira.v3.model.JiraExpressionEvalRequestBean;
import com.atlassian.jira.v3.model.JiraExpressionForAnalysis;
import com.atlassian.jira.v3.model.JiraExpressionResult;
import com.atlassian.jira.v3.model.JiraExpressionsAnalysis;
...
public interface JiraExpressionsApi {
	...
	JiraExpressionsAnalysis analyseExpression(JiraExpressionForAnalysis jiraExpressionForAnalysis, @QueryParam("check") @DefaultValue("syntax") String check) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	JiraExpressionResult evaluateJiraExpression(JiraExpressionEvalRequestBean jiraExpressionEvalRequestBean, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
}
