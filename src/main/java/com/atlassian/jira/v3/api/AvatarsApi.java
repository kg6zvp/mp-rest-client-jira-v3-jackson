...
public interface AvatarsApi {
	...
	void getAvatarImageByID(@PathParam("type") String type, @PathParam("id") Long id, @QueryParam("size") String size, @QueryParam("format") String format) throws ApiException, ProcessingException;
	...
	@Produces({"*/*", "application/json", "image/png", "image/svg+xml"})
	void getAvatarImageByOwner(@PathParam("type") String type, @PathParam("entityId") String entityId, @QueryParam("size") String size, @QueryParam("format") String format) throws ApiException, ProcessingException;
	...
	@Produces({"*/*", "application/json", "image/png", "image/svg+xml"})
	void getAvatarImageByType(@PathParam("type") String type, @QueryParam("size") String size, @QueryParam("format") String format) throws ApiException, ProcessingException;
