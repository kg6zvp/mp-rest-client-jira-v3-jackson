...
import com.atlassian.jira.v3.model.PermissionGrant;
import com.atlassian.jira.v3.model.PermissionGrants;
import com.atlassian.jira.v3.model.PermissionScheme;
import com.atlassian.jira.v3.model.PermissionSchemes;
...
public interface PermissionSchemesApi {
	...
	PermissionGrant createPermissionGrant(@PathParam("schemeId") Long schemeId, PermissionGrant permissionGrant, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	PermissionScheme createPermissionScheme(PermissionScheme permissionScheme, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@DELETE
	@Path("/{schemeId}")
	void deletePermissionScheme(@PathParam("schemeId") Long schemeId) throws ApiException, ProcessingException;
	...
	void deletePermissionSchemeEntity(@PathParam("schemeId") Long schemeId, @PathParam("permissionId") Long permissionId) throws ApiException, ProcessingException;
	...
	@Produces({"application/json"})
	PermissionSchemes getAllPermissionSchemes(@QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@Path("/{schemeId}")
	@Produces({"application/json"})
	PermissionScheme getPermissionScheme(@PathParam("schemeId") Long schemeId, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@Path("/{schemeId}/permission/{permissionId}")
	@Produces({"application/json"})
	PermissionGrant getPermissionSchemeGrant(@PathParam("schemeId") Long schemeId, @PathParam("permissionId") Long permissionId, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@Path("/{schemeId}/permission")
	@Produces({"application/json"})
	PermissionGrants getPermissionSchemeGrants(@PathParam("schemeId") Long schemeId, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
	...
	@Consumes({"application/json"})
	@Produces({"application/json"})
	PermissionScheme updatePermissionScheme(@PathParam("schemeId") Long schemeId, PermissionScheme permissionScheme, @QueryParam("expand") String expand) throws ApiException, ProcessingException;
}
