...
import com.atlassian.jira.v3.model.ApplicationProperty;
import com.atlassian.jira.v3.model.ModelConfiguration;
import com.atlassian.jira.v3.model.SimpleApplicationPropertyBean;
...
@Path("/rest/api/3")
public interface JiraSettingsApi {
	...
	List<ApplicationProperty> getAdvancedSettings() throws ApiException, ProcessingException;
	...
	@Produces({"application/json"})
	List<ApplicationProperty> getApplicationProperty(@QueryParam("key") String key, @QueryParam("permissionLevel") String permissionLevel, @QueryParam("keyFilter") String keyFilter) throws ApiException, ProcessingException;
	...
	@Path("/configuration")
	@Produces({"application/json"})
	ModelConfiguration getConfiguration() throws ApiException, ProcessingException;
	...
	@Produces({"application/json"})
	ApplicationProperty setApplicationProperty(@PathParam("id") String id, SimpleApplicationPropertyBean simpleApplicationPropertyBean) throws ApiException, ProcessingException;
}
